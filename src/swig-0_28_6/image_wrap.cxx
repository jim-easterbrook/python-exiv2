...
#define SWIGTYPE_p_Exiv2__CurlIo swig_types[5]
...
#define SWIGTYPE_p_IptcData_iterator_base swig_types[44]
...
SWIGINTERN PyObject *_wrap_Image_appendIccProfile(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  Exiv2::Image *arg1 = (Exiv2::Image *) 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "Image_appendIccProfile", 2, 3, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Exiv2__Image, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Image_appendIccProfile" "', argument " "1"" of type '" "Exiv2::Image *""'"); 
  }
  arg1 = reinterpret_cast< Exiv2::Image * >(argp1);
  res2 = SWIG_ConvertPtr(swig_obj[0], &argp2,SWIGTYPE_p_unsigned_char, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "Image_appendIccProfile" "', argument " "2"" of type '" "uint8_t const *""'"); 
  }
  arg2 = reinterpret_cast< uint8_t * >(argp2);
  ecode3 = SWIG_AsVal_size_t(swig_obj[1], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "Image_appendIccProfile" "', argument " "3"" of type '" "size_t""'");
  } 
  arg3 = static_cast< size_t >(val3);
  if (swig_obj[2]) {
    ecode4 = SWIG_AsVal_bool(swig_obj[2], &val4);
    if (!SWIG_IsOK(ecode4)) {
      SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "Image_appendIccProfile" "', argument " "4"" of type '" "bool""'");
    } 
    arg4 = static_cast< bool >(val4);
  }
  {
    try {
      (arg1)->appendIccProfile((uint8_t const *)arg2,SWIG_STD_MOVE(arg3),arg4);
    }
    catch(std::exception const& e) {
      _set_python_exception();
      SWIG_fail;
...
SWIGINTERN PyObject *_wrap_Image_checkIccProfile(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  Exiv2::Image *arg1 = (Exiv2::Image *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (!SWIG_Python_UnpackTuple(args, "Image_checkIccProfile", 0, 0, 0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Exiv2__Image, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Image_checkIccProfile" "', argument " "1"" of type '" "Exiv2::Image *""'"); 
  }
  arg1 = reinterpret_cast< Exiv2::Image * >(argp1);
  {
    try {
      (arg1)->checkIccProfile();
    }
    catch(std::exception const& e) {
      _set_python_exception();
      SWIG_fail;
...
SWIGINTERN PyObject *_wrap_Image_iccProfileDefined(PyObject *self, PyObject *args) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Exiv2__Image, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Image_iccProfileDefined" "', argument " "1"" of type '" "Exiv2::Image const *""'"); 
  }
  arg1 = reinterpret_cast< Exiv2::Image * >(argp1);
  {
    try {
      result = (bool)((Exiv2::Image const *)arg1)->iccProfileDefined();
    }
    catch(std::exception const& e) {
      _set_python_exception();
      SWIG_fail;
...
SWIGINTERN PyMethodDef SwigPyBuiltin__Exiv2__Image_methods[] = {
  ...
  { "setIccProfile", _wrap_Image_setIccProfile, METH_VARARGS, "\n"
		...
		"" },
  { "appendIccProfile", _wrap_Image_appendIccProfile, METH_VARARGS, "\n"
		"Append more bytes to the iccProfile.\n"
		":type bytes: uint8_t\n"
		":param bytes: array of bytes to append\n"
		":type size: int\n"
		":param size: number of bytes to append\n"
		":type bTestValid: bool\n"
		":param bTestValid: - tests that iccProfile contains credible data\n"
		"" },
  { "checkIccProfile", _wrap_Image_checkIccProfile, METH_NOARGS, "Throw an exception if the size at the beginning of the iccProfile isn't correct." },
