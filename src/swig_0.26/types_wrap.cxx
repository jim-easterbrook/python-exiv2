...
SWIGINTERN int _wrap_new_DataBuf__SWIG_4(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  SwigValueWrapper< Exiv2::DataBufRef > arg1 ;
  void *argp1 ;
  int res1 = 0 ;
  Exiv2::DataBuf *result = 0 ;
  ...
  if ((nobjs < 1) || (nobjs > 1)) SWIG_fail;
  {
    ...
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_DataBuf" "', argument " "1"" of type '" "Exiv2::DataBufRef""'"); 
    }  
    if (!argp1) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_DataBuf" "', argument " "1"" of type '" "Exiv2::DataBufRef""'");
    } else {
      Exiv2::DataBufRef * temp = reinterpret_cast< Exiv2::DataBufRef * >(argp1);
      arg1 = *temp;
      if (SWIG_IsNewObj(res1)) delete temp;
    }
  }
...
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'new_DataBuf'.\n"
    ...
    "    Exiv2::DataBuf::DataBuf(Exiv2::DataBufRef)\n");
  return -1;
}
