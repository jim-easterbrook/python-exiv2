...
# endif
  ...
  d = md;
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerGeneralError",SWIG_From_int(static_cast< int >(Exiv2::kerGeneralError)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerSuccess",SWIG_From_int(static_cast< int >(Exiv2::kerSuccess)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerErrorMessage",SWIG_From_int(static_cast< int >(Exiv2::kerErrorMessage)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerCallFailed",SWIG_From_int(static_cast< int >(Exiv2::kerCallFailed)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerNotAnImage",SWIG_From_int(static_cast< int >(Exiv2::kerNotAnImage)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerInvalidDataset",SWIG_From_int(static_cast< int >(Exiv2::kerInvalidDataset)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerInvalidRecord",SWIG_From_int(static_cast< int >(Exiv2::kerInvalidRecord)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerInvalidKey",SWIG_From_int(static_cast< int >(Exiv2::kerInvalidKey)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerInvalidTag",SWIG_From_int(static_cast< int >(Exiv2::kerInvalidTag)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerValueNotSet",SWIG_From_int(static_cast< int >(Exiv2::kerValueNotSet)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerDataSourceOpenFailed",SWIG_From_int(static_cast< int >(Exiv2::kerDataSourceOpenFailed)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerFileOpenFailed",SWIG_From_int(static_cast< int >(Exiv2::kerFileOpenFailed)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerFileContainsUnknownImageType",SWIG_From_int(static_cast< int >(Exiv2::kerFileContainsUnknownImageType)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerMemoryContainsUnknownImageType",SWIG_From_int(static_cast< int >(Exiv2::kerMemoryContainsUnknownImageType)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerUnsupportedImageType",SWIG_From_int(static_cast< int >(Exiv2::kerUnsupportedImageType)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerFailedToReadImageData",SWIG_From_int(static_cast< int >(Exiv2::kerFailedToReadImageData)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerNotAJpeg",SWIG_From_int(static_cast< int >(Exiv2::kerNotAJpeg)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerFailedToMapFileForReadWrite",SWIG_From_int(static_cast< int >(Exiv2::kerFailedToMapFileForReadWrite)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerFileRenameFailed",SWIG_From_int(static_cast< int >(Exiv2::kerFileRenameFailed)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerTransferFailed",SWIG_From_int(static_cast< int >(Exiv2::kerTransferFailed)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerMemoryTransferFailed",SWIG_From_int(static_cast< int >(Exiv2::kerMemoryTransferFailed)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerInputDataReadFailed",SWIG_From_int(static_cast< int >(Exiv2::kerInputDataReadFailed)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerImageWriteFailed",SWIG_From_int(static_cast< int >(Exiv2::kerImageWriteFailed)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerNoImageInInputData",SWIG_From_int(static_cast< int >(Exiv2::kerNoImageInInputData)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerInvalidIfdId",SWIG_From_int(static_cast< int >(Exiv2::kerInvalidIfdId)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerValueTooLarge",SWIG_From_int(static_cast< int >(Exiv2::kerValueTooLarge)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerDataAreaValueTooLarge",SWIG_From_int(static_cast< int >(Exiv2::kerDataAreaValueTooLarge)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerOffsetOutOfRange",SWIG_From_int(static_cast< int >(Exiv2::kerOffsetOutOfRange)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerUnsupportedDataAreaOffsetType",SWIG_From_int(static_cast< int >(Exiv2::kerUnsupportedDataAreaOffsetType)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerInvalidCharset",SWIG_From_int(static_cast< int >(Exiv2::kerInvalidCharset)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerUnsupportedDateFormat",SWIG_From_int(static_cast< int >(Exiv2::kerUnsupportedDateFormat)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerUnsupportedTimeFormat",SWIG_From_int(static_cast< int >(Exiv2::kerUnsupportedTimeFormat)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerWritingImageFormatUnsupported",SWIG_From_int(static_cast< int >(Exiv2::kerWritingImageFormatUnsupported)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerInvalidSettingForImage",SWIG_From_int(static_cast< int >(Exiv2::kerInvalidSettingForImage)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerNotACrwImage",SWIG_From_int(static_cast< int >(Exiv2::kerNotACrwImage)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerFunctionNotSupported",SWIG_From_int(static_cast< int >(Exiv2::kerFunctionNotSupported)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerNoNamespaceInfoForXmpPrefix",SWIG_From_int(static_cast< int >(Exiv2::kerNoNamespaceInfoForXmpPrefix)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerNoPrefixForNamespace",SWIG_From_int(static_cast< int >(Exiv2::kerNoPrefixForNamespace)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerTooLargeJpegSegment",SWIG_From_int(static_cast< int >(Exiv2::kerTooLargeJpegSegment)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerUnhandledXmpdatum",SWIG_From_int(static_cast< int >(Exiv2::kerUnhandledXmpdatum)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerUnhandledXmpNode",SWIG_From_int(static_cast< int >(Exiv2::kerUnhandledXmpNode)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerXMPToolkitError",SWIG_From_int(static_cast< int >(Exiv2::kerXMPToolkitError)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerDecodeLangAltPropertyFailed",SWIG_From_int(static_cast< int >(Exiv2::kerDecodeLangAltPropertyFailed)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerDecodeLangAltQualifierFailed",SWIG_From_int(static_cast< int >(Exiv2::kerDecodeLangAltQualifierFailed)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerEncodeLangAltPropertyFailed",SWIG_From_int(static_cast< int >(Exiv2::kerEncodeLangAltPropertyFailed)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerPropertyNameIdentificationFailed",SWIG_From_int(static_cast< int >(Exiv2::kerPropertyNameIdentificationFailed)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerSchemaNamespaceNotRegistered",SWIG_From_int(static_cast< int >(Exiv2::kerSchemaNamespaceNotRegistered)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerNoNamespaceForPrefix",SWIG_From_int(static_cast< int >(Exiv2::kerNoNamespaceForPrefix)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerAliasesNotSupported",SWIG_From_int(static_cast< int >(Exiv2::kerAliasesNotSupported)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerInvalidXmpText",SWIG_From_int(static_cast< int >(Exiv2::kerInvalidXmpText)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerTooManyTiffDirectoryEntries",SWIG_From_int(static_cast< int >(Exiv2::kerTooManyTiffDirectoryEntries)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerMultipleTiffArrayElementTagsInDirectory",SWIG_From_int(static_cast< int >(Exiv2::kerMultipleTiffArrayElementTagsInDirectory)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerWrongTiffArrayElementTagType",SWIG_From_int(static_cast< int >(Exiv2::kerWrongTiffArrayElementTagType)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerInvalidKeyXmpValue",SWIG_From_int(static_cast< int >(Exiv2::kerInvalidKeyXmpValue)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerInvalidIccProfile",SWIG_From_int(static_cast< int >(Exiv2::kerInvalidIccProfile)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerInvalidXMP",SWIG_From_int(static_cast< int >(Exiv2::kerInvalidXMP)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerTiffDirectoryTooLarge",SWIG_From_int(static_cast< int >(Exiv2::kerTiffDirectoryTooLarge)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerInvalidTypeValue",SWIG_From_int(static_cast< int >(Exiv2::kerInvalidTypeValue)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerInvalidLangAltValue",SWIG_From_int(static_cast< int >(Exiv2::kerInvalidLangAltValue)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerInvalidMalloc",SWIG_From_int(static_cast< int >(Exiv2::kerInvalidMalloc)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerCorruptedMetadata",SWIG_From_int(static_cast< int >(Exiv2::kerCorruptedMetadata)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerArithmeticOverflow",SWIG_From_int(static_cast< int >(Exiv2::kerArithmeticOverflow)));
  SWIG_Python_SetConstant(d, d == md ? public_interface : NULL, "kerMallocFailed",SWIG_From_int(static_cast< int >(Exiv2::kerMallocFailed)));
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
