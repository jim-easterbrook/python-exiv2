...
SWIGINTERN PyObject *_wrap_Iptcdatum_pointer_toLong(PyObject *self, PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Iptcdatum_pointer_toLong", 0, 1, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_MetadatumPointerT_Exiv2__Iptcdatum_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_Iptcdatum_toLong(PyObject *self, PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Iptcdatum_toLong", 0, 1, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Exiv2__Iptcdatum, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
