...
#define SWIGTYPE_p_byte_buffer swig_types[3]
...
SWIGINTERN int _wrap_new_DataBuf__SWIG_2(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "new_DataBuf" "', argument " "2"" of type '" "size_t""'");
  } 
...
SWIGINTERN PyObject *_wrap_DataBuf_cmpBytes(PyObject *self, PyObject *args) {
  ...
  (void)self;
  if (!SWIG_Python_UnpackTuple(args, "DataBuf_cmpBytes", 3, 3, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Exiv2__DataBuf, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "DataBuf_cmpBytes" "', argument " "3"" of type '" "void const *""'"); 
  }
  ecode4 = SWIG_AsVal_size_t(swig_obj[2], &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "DataBuf_cmpBytes" "', argument " "4"" of type '" "size_t""'");
  } 
  arg4 = static_cast< size_t >(val4);
  {
    try {
      result = (int)((Exiv2::DataBuf const *)arg1)->cmpBytes(arg2,(void const *)arg3,arg4);
...
SWIGINTERN PyObject *_wrap_DataBuf_data__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  Exiv2::DataBuf *arg1 = (Exiv2::DataBuf *) 0 ;
  size_t arg2 ;
  void *argp1 = 0 ;
  ...
  ecode2 = SWIG_AsVal_size_t(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "DataBuf_data" "', argument " "2"" of type '" "size_t""'");
  } 
  arg2 = static_cast< size_t >(val2);
  {
    try {
      result = (Exiv2::byte *)(arg1)->data(arg2);
...
SWIGINTERN PyObject *_wrap_DataBuf_data__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **SWIGUNUSEDPARM(swig_obj)) {
  PyObject *resultobj = 0;
  Exiv2::DataBuf *arg1 = (Exiv2::DataBuf *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN PyObject *_wrap_DataBuf_data(PyObject *self, PyObject *args) {
  ...
  (void)self;
  if (!(argc = SWIG_Python_UnpackTuple(args, "DataBuf_data", 0, 2, argv+1))) SWIG_fail;
  argv[0] = self;
  if (argc == 1) {
    PyObject *retobj = _wrap_DataBuf_data__SWIG_1(self, argc, argv);
    if (!SWIG_Python_TypeErrorOccurred(retobj)) return retobj;
    SWIG_fail;
  }
  if (argc == 2) {
    PyObject *retobj = _wrap_DataBuf_data__SWIG_0(self, argc, argv);
    if (!SWIG_Python_TypeErrorOccurred(retobj)) return retobj;
    SWIG_fail;
  }
  
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'DataBuf_data'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    Exiv2::DataBuf::data(size_t)\n"
    "    Exiv2::DataBuf::data()\n");
  return 0;
}
...
static PyHeapTypeObject SwigPyBuiltin__byte_buffer_type = {
  {
    ...
    0,                                        /* ob_size */
#endif
    "exiv2.types.byte_buffer",                /* tp_name */
    sizeof(SwigPyObject),                     /* tp_basicsize */
    0,                                        /* tp_itemsize */
...
SWIGINTERN PyMethodDef SwigPyBuiltin__Exiv2__DataBuf_methods[] = {
  ...
  { "data", _wrap_DataBuf_data, METH_VARARGS, " Returns a data pointer." },
