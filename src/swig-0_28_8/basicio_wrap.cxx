...
#define SWIGTYPE_p_std__pairT_int32_t_int32_t_t swig_types[14]
#define SWIGTYPE_p_std__pairT_uint32_t_uint32_t_t swig_types[15]
...
static void releasebuffer_Exiv2_BasicIo(
...
SWIGINTERN PyObject *_wrap_BasicIo_write__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  }
  {
    ...
    try {
      {
        SWIG_PYTHON_THREAD_BEGIN_ALLOW;
        result = (arg1)->write((Exiv2::byte const *)arg2,SWIG_STD_MOVE(*(&arg3)));
        SWIG_PYTHON_THREAD_END_ALLOW;
      }
    }
    catch(std::exception const& e) {
...
SWIGINTERN PyObject *_wrap_BasicIo_write__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  if (!argp2) {
    SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "BasicIo_write" "', argument " "2"" of type '" "Exiv2::BasicIo &""'"); 
  }
...
SWIGINTERN PyObject *_wrap_BasicIo_write(PyObject *self, PyObject *args) {
  ...
  if (argc == 2) {
    ...
    if (!_v) goto check_1;
    return _wrap_BasicIo_write__SWIG_1(self, argc, argv);
  }
check_1:
...
SWIGINTERN PyObject *_wrap_BasicIo_read__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  }
  {
    ...
    try {
      {
        SWIG_PYTHON_THREAD_BEGIN_ALLOW;
        result = (arg1)->read(SWIG_STD_MOVE(*(&arg2)));
        SWIG_PYTHON_THREAD_END_ALLOW;
      }
    }
    catch(std::exception const& e) {
...
SWIGINTERN PyObject *_wrap_BasicIo_read__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  arg1 = reinterpret_cast< Exiv2::BasicIo * >(argp1);
  {
    ...
    if (PyObject_GetBuffer(
        swig_obj[1], &_global_buff, PyBUF_CONTIG | PyBUF_WRITABLE) < 0) {
      PyErr_Clear();
  ...
  }
  {
    ...
    try {
      {
        SWIG_PYTHON_THREAD_BEGIN_ALLOW;
        result = (arg1)->read(arg2,SWIG_STD_MOVE(*(&arg3)));
        SWIG_PYTHON_THREAD_END_ALLOW;
      }
    }
    catch(std::exception const& e) {
...
SWIGINTERN PyObject *_wrap_BasicIo_read(PyObject *self, PyObject *args) {
  ...
  if (argc == 2) {
    ...
    if (!_v) goto check_1;
    return _wrap_BasicIo_read__SWIG_0(self, argc, argv);
  }
check_1:
...
SWIGINTERN PyObject *_wrap_BasicIo_readOrThrow(PyObject *self, PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "BasicIo_readOrThrow", 1, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Exiv2__BasicIo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  if (swig_obj[1]) {
    {
      res4 = SWIG_ConvertPtr(swig_obj[1], &argp4, SWIGTYPE_p_ErrorCode,  0  | 0);
      if (!SWIG_IsOK(res4)) {
        SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "BasicIo_readOrThrow" "', argument " "4"" of type '" "ErrorCode""'"); 
      }  
      if (!argp4) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "BasicIo_readOrThrow" "', argument " "4"" of type '" "ErrorCode""'");
      } else {
  ...
  {
    PyErr_WarnEx(PyExc_DeprecationWarning, "Python scripts should not need to call ""Exiv2::BasicIo::readOrThrow", 1);
    try {
...
SWIGINTERN PyObject *_wrap_BasicIo_seek(PyObject *self, PyObject *args) {
  ...
  {
    if (!PyObject_IsInstance(swig_obj[1], Python_Exiv2_BasicIo_Position)) {
    ...
    arg3 = static_cast< Exiv2::BasicIo::Position >(PyLong_AsLong(swig_obj[1]));
  }
  {
...
SWIGINTERN PyObject *_wrap_BasicIo_seekOrThrow(PyObject *self, PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "BasicIo_seekOrThrow", 2, 3, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Exiv2__BasicIo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  if (swig_obj[2]) {
    {
      res4 = SWIG_ConvertPtr(swig_obj[2], &argp4, SWIGTYPE_p_ErrorCode,  0  | 0);
      if (!SWIG_IsOK(res4)) {
        SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "BasicIo_seekOrThrow" "', argument " "4"" of type '" "ErrorCode""'"); 
      }  
      if (!argp4) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "BasicIo_seekOrThrow" "', argument " "4"" of type '" "ErrorCode""'");
      } else {
        ErrorCode * temp = reinterpret_cast< ErrorCode * >(argp4);
        arg4 = *temp;
        if (SWIG_IsNewObj(res4)) delete temp;
  ...
  {
    PyErr_WarnEx(PyExc_DeprecationWarning, "Python scripts should not need to call ""Exiv2::BasicIo::seekOrThrow", 1);
    try {
...
SWIGINTERN PyObject *_wrap_BasicIo_mmap(PyObject *self, PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "BasicIo_mmap", 0, 1, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Exiv2__BasicIo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_BasicIo_ioType(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  Exiv2::BasicIo *arg1 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "BasicIo_ioType", 0, 0, 0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Exiv2__BasicIo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_BasicIo_data(PyObject *self, PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "BasicIo_data", 0, 1, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Exiv2__BasicIo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyGetSetDef SwigPyBuiltin__Exiv2__BasicIo_getset[] = {
    { (char *)"__dict__", SwigPyBuiltin_FunpackGetterClosure, 0, (char *)"dictionary for instance variables", &BasicIo___dict___getset },
...
SWIGINTERN PyMethodDef SwigPyBuiltin__Exiv2__BasicIo_methods[] = {
  ...
  { "putb", _wrap_BasicIo_putb, METH_O, "Deprecated." },
  { "read", _wrap_BasicIo_read, METH_VARARGS, "Deprecated." },
  { "readOrThrow", _wrap_BasicIo_readOrThrow, METH_VARARGS, "Deprecated." },
  { "getb", _wrap_BasicIo_getb, METH_NOARGS, "Deprecated." },
  { "transfer", _wrap_BasicIo_transfer, METH_O, "Deprecated." },
  ...
  { "munmap", _wrap_BasicIo_munmap, METH_NOARGS, "\n"
		...
		"            Nonzero if failure;\n"
		"" },
  { "tell", _wrap_BasicIo_tell, METH_NOARGS, "Deprecated." },
  ...
  { "eof", _wrap_BasicIo_eof, METH_NOARGS, "Deprecated." },
  { "path", _wrap_BasicIo_path, METH_NOARGS, "\n"
		...
		"    available.\n"
		"" },
  { "ioType", _wrap_BasicIo_ioType, METH_NOARGS, "\n"
  ...
  { "data", _wrap_BasicIo_data, METH_VARARGS, "\n"
		...
		":rtype: memoryview\n"
		"" },
  { "_view_deleted_cb", _wrap_BasicIo__view_deleted_cb, METH_O, "" },
...
# endif
  ...
  {
    getbuffer_Exiv2_BasicIo,                /* bf_getbuffer */
    releasebuffer_Exiv2_BasicIo,            /* bf_releasebuffer */
  },
    (PyObject *) 0,                         /* ht_name */
    (PyObject *) 0,                         /* ht_slots */
...
static PyTypeObject *SwigPyBuiltin__Exiv2__BasicIo_type_create(PyTypeObject *type, PyTypeObject **bases, PyObject *dict) {
  PyObject *tuple_bases;
  PyTypeObject *pytype = (PyTypeObject *)&SwigPyBuiltin__Exiv2__BasicIo_type;
  pytype->tp_dict = dict;
...
static PyTypeObject *SwigPyBuiltin__Exiv2__BasicIo_type_create(PyTypeObject *type, PyTypeObject **bases, PyObject *dict) {
  PyType_Slot slots[] = {
    ...
    { Py_tp_dealloc,                    (void *)(destructor) _wrap_delete_BasicIo_destructor_closure },
    { Py_tp_doc,                        (void *)"\n"
		"An interface for simple binary IO.\n"
		"\n"
		"This appears to be mainly for use internally by libexiv2, apart from\n"
    ...
    { Py_sq_length,                     (void *)(lenfunc) _wrap_BasicIo_size_lenfunc_closure },
#if !defined(Py_LIMITED_API) && PY_VERSION_HEX >= 0x03090000 || Py_LIMITED_API+0 >= 0x030b0000
    { Py_bf_getbuffer,                  (void *)(getbufferproc) getbuffer_Exiv2_BasicIo },
    { Py_bf_releasebuffer,              (void *)(releasebufferproc) releasebuffer_Exiv2_BasicIo },
#endif
    { 0, NULL }
  };
  PyType_Spec spec = {
  ...
  if (pytype) {
    pytype->tp_as_buffer->bf_getbuffer = getbuffer_Exiv2_BasicIo;
    pytype->tp_as_buffer->bf_releasebuffer = releasebuffer_Exiv2_BasicIo;
  }
#endif
  if (pytype) {
...
#endif
SWIGINTERN SwigPyClientData SwigPyBuiltin__Exiv2__BasicIo_clientdata = {0, 0, 0, 0, 0, 0, 0};
...
SWIGINTERN int SWIG_mod_exec(PyObject *m) {
  ...
  builtin_pytype = SwigPyBuiltin__Exiv2__BasicIo_type_create(metatype, builtin_bases, d);
  if(!builtin_pytype) {
    return -1;
  }
  SwigPyBuiltin__Exiv2__BasicIo_clientdata.pytype = builtin_pytype;
  SWIG_Py_INCREF((PyObject *)builtin_pytype);
  if (PyModule_AddObject(m, "BasicIo", (PyObject *)builtin_pytype) != 0) {
